...
public class CatRiderSpeechlet implements SpeechletV2{

	public static final String INVOCATION_NAME = "Cat Rider";
	
	private static Logger log = LoggerFactory.getLogger(CatRiderSpeechlet.class);
